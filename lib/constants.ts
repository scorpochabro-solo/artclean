...
export const SITE_TITLE =
  "Клининговая компания в Костроме — уборка домов, офисов и коммерческих объектов | Арт Клининг";
export const SITE_DESCRIPTION =
  "Профессиональная уборка домов, офисов и коммерческих объектов: генеральная, после ремонта, поддерживающая, baby-клининг. Кострома и область; также Иваново, Ярославль, Санкт-Петербург и Москва. Современное оборудование, сертифицированные средства, смета до начала работ.";

// Аналитика. Рендерится только если ID задан. TODO: вставить идентификаторы.
export const YM_ID = "110736068";
export const GA_ID = "";

// География: основная для SEO — Кострома; вторичные регионы — по решению клиента.
