...
export function GET() {
  const lines = [
    `# ${SITE_NAME}`,
    "",
    `> ${SITE_NAME} — премиальная клининговая компания в Костроме. Слоган: «${SITE_SLOGAN}». Профессиональная уборка домов, офисов и коммерческих объектов (включая площади от 1000 м²). Основная география — Кострома и область; также Ивановская и Ярославская области, Санкт-Петербург и Москва.`,
    "",
    "Ключевые факты:",
    ...
    "- Смета фиксируется до начала работ; каждый этап работ принимается ответственным лицом клиента и фиксируется.",
    "",
    "## Услуги",
    "",
