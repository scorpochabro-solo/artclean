      ...
      <Container className="max-w-[880px] pb-20 pt-[calc(var(--header-h)+2.5rem)] md:pb-28">
        ...
        <section className="mt-16 rounded-[20px] border border-milk-200 p-7 md:p-9">
          ...
          <ul className="mt-6 grid gap-4 sm:grid-cols-2">
            {[
              "Современное оборудование и профессиональный инвентарь",
              "Профессиональные сертифицированные моющие средства",
              "Обученный персонал, прошедший специальную подготовку",
              "Стоимость фиксируем до начала работ — без доплат по факту",
              "Работаем в Костроме и области, Иванове, Ярославле, Санкт-Петербурге и Москве",
            ].map((t, i) => (
